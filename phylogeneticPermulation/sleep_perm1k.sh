...
#SBATCH --error=/projects/pfenninggroup/machineLearningForComputationalBiology/VocalLearningTACIT/data/putamenPermulation/sleep/log/perm1k_err_%A_%a.txt
#SBATCH --output=/projects/pfenninggroup/machineLearningForComputationalBiology/VocalLearningTACIT/data/putamenPermulation/sleep/log/perm1k_%A_%a.txt
#SBATCH --mem=6G
...
out="/projects/pfenninggroup/machineLearningForComputationalBiology/VocalLearningTACIT/data/putamenPermulation/sleep/perm1k/sleep_perm_1k.csv"
perm="/projects/pfenninggroup/machineLearningForComputationalBiology/VocalLearningTACIT/data/putamenPermulation/sleep/sleep_perm1k_peakList.csv"
...
$tree $preds $species $traits $out ${SLURM_ARRAY_TASK_ID} 200 \
