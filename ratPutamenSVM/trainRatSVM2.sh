...
#SBATCH --error=log/svmTrain2_%A_%a.err.txt
#SBATCH --output=log/svmTrain2_%A_%a.txt
#SBATCH --mem=24G
#SBATCH --array=1-7%7
...
k=$(($l-4))
outModel=${wd}/rat_svm_t1_len${l}
../bin/gkmtrain -l ${l} -k ${k} -m 4096 -T 4 $posTrain $negTrain $outModel
